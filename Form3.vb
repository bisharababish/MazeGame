Public Class Form3
    ...
    Private Sub Finish_MouseEnter(sender As Object, e As EventArgs) Handles Finish_Click.MouseEnter
        MessageBox.Show("GG")

    End Sub

    Private Sub label61_Click(sender As Object, e As EventArgs) Handles Finish_Click.Click
    End Sub
